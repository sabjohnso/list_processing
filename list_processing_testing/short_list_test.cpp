...
namespace ListProcessing::Testing {
  ...
  TEST(ShortList, InitialValue) { ASSERT_EQ(head(ShortList<int, 32>(1)), 1); }
  ...
  TEST(ShortList, LengthTail1Reverse3) {
    ASSERT_EQ(
      length(tail(reverse(cons(1, cons(2, ShortList<int, 32>(3)))))), 2);
  }

  TEST(ShortList, LengthTail2Reverse3) {
    ASSERT_EQ(
      length(tail(tail(reverse(cons(1, cons(2, ShortList<int, 32>(3))))))), 1);
  }
  ...
  TEST(ShortList, HeadTail2Reverse3) {
    ASSERT_EQ(
      head(tail(tail(reverse(cons(1, cons(2, ShortList<int, 32>(3))))))), 1);
  }
  ...
  TEST(ShortList, Access) {
    ...
    ASSERT_EQ(
      (short_list<int, 32>(1, 2, 3, 4)), (short_list<int, 32>(1, 2, 3, 4)));
    ASSERT_NE(
      (short_list<int, 32>(1, 2, 3, 4)), (short_list<int, 32>(1, 2, 3)));
    ASSERT_NE(
      (short_list<int, 32>(1, 2, 3, 4)), (short_list<int, 32>(1, 2, 3, 5)));

    ASSERT_EQ(
      drop(short_list<int, 32>(1, 2, 3, 4), 0),
      (short_list<int, 32>(1, 2, 3, 4)));
    ASSERT_EQ(
      drop(short_list<int, 32>(1, 2, 3, 4), 1), (short_list<int, 32>(2, 3, 4)));
    ASSERT_EQ(
      drop(short_list<int, 32>(1, 2, 3, 4), 2), (short_list<int, 32>(3, 4)));
    ASSERT_EQ(
      drop(short_list<int, 32>(1, 2, 3, 4), 3), (short_list<int, 32>(4)));

    ASSERT_EQ(
      take(short_list<int, 32>(1, 2, 3, 4), 4),
      (short_list<int, 32>(1, 2, 3, 4)));
    ASSERT_EQ(
      take(short_list<int, 32>(1, 2, 3, 4), 3), (short_list<int, 32>(1, 2, 3)));
    ASSERT_EQ(
      take(short_list<int, 32>(1, 2, 3, 4), 2), (short_list<int, 32>(1, 2)));
    ASSERT_EQ(
      take(short_list<int, 32>(1, 2, 3, 4), 1), (short_list<int, 32>(1)));
  }
  ...
  TEST(ShortList, ReverseAccess) {
    ...
    ASSERT_EQ(
      head(tail(tail(tail(reverse(short_list<int, 32>(1, 2, 3, 4)))))), 1);
